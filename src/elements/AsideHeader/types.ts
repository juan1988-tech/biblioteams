...
export type AsideHeaderProps = "w-2/4 h-full bg-white-font tablet-hor:hidden flex items-center justify-center z-20 fixed top-0 left-0 transition-all duration-1000 max-cellphone:items-start max-cellphone-hor:w-2/3"
