...
export const workshopCardList:WorkShopCardSet =[
    {
      ...
      className:{
        classNameElement:"h-105 bg-[url(/src/assets/images/activities/activities-club-infantil.jpg)] bg-no-repeat bg-cover text-white-font p-4",
    ...
    {
      tittle:"Club de Ajedrez",
      description:"Club para fomentar y patrocinar la práctica y la cultura del ajedrez",
      schedule:"Sábado: 09: 00 a.m. - 10: 00 a.m.",
      className:{
        classNameElement:"h-105 bg-[url(/src/assets/images/activities/activities-club-ajedrez.jpg)] bg-no-repeat bg-cover text-white-font p-4",
    ...
    },
    {
      ...
      className:{
        classNameElement:"h-105 bg-[url(/src/assets/images/activities/activities-pre-icfes.jpg)] bg-no-repeat bg-cover text-white-font p-4",
    ...
    },
    {
      ...
      schedule:"Viernes: 05: 00 p.m. - 06: 00 p.m.",
      className:{
        classNameElement:"h-105 bg-[url(/src/assets/images/activities/activities-english-club.jpg)] bg-no-repeat bg-cover text-white-font p-4",
