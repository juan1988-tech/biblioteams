    ...
    <section className="h-full w-full bg-white-font max-tablet-hor:h-157.5 max-cellphone-hor:h-80 max-cellphone:h-auto">
      <div className="w-[95%] mx-auto flex h-full max-cellphone:w-full max-cellphone:mx-0">
        <article className="flex w-11/12 mx-auto max-w-286 max-tablet-hor:w-214 max-tablet-hor:mx-auto max-cellphone:flex-col">
          ...
          max-tablet-hor:grid-cols-[159px_152px_1fr] max-tablet-hor:w-2/4 max-tablet:w-2/4 max-tablet:grid-cols-[96px_87px_1fr]
          ...
          max-cellphone:grid-cols-3">
            ...
            max-tablet-hor:text-font-big-40 max-tablet-hor:self-end max-tablet:text-font-big-tittle max-cellphone-hor:text-font-h3-24 max-cellphone:w-full max-cellphone:text-center justify-center max-cellphone:col-start-1 max-cellphone:col-end-4">Biblioteams</h1>
            ...
            max-tablet:text-font-h2-28 max-cellphone-hor:text-font-h4-20 max-cellphone:text-center max-cellphone:justify-center ">Un espacio de formación para niños y jóvenes</p>
          </div>
