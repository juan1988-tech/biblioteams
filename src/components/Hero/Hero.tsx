    ...
    <section className="h-full w-full bg-white-font">
      <div className="w-[95%] mx-auto flex">
        <article className="flex w-11/12 mx-auto max-w-286 max-tablet-hor:w-full max-tablet-hor:mx-0">
          ...
          max-tablet-hor:grid-cols-[68px_195px_118px_1fr] max-tablet-hor:w-130">
          ...
          <figure className="w-125 h-125 max-tablet-hor:w-102.5 max-tablet-hor:h-102.5 max-tablet-hor:self-center ">
